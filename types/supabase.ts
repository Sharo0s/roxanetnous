...
// Derniere regeneration : story 7.A.7 (2026-05-14) apres migration CHECK XOR admin_actions_log.target_id / target_id_text + DROP NOT NULL target_id (diff target_id: string -> string | null dans Row+Insert+Update).
