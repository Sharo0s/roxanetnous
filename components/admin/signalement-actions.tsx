    ...
    <div className="ml-4 min-w-[200px]">
      ...
      <div className="mb-2">
        ...
        <select
          ...
          className="w-full rounded-xl border border-[#e8dfd2] bg-white px-2 py-1.5 text-sm focus:outline-none focus:border-kraft focus:ring-1 focus:ring-kraft transition"
        >
      ...
      <div className="mb-2">
        ...
        <textarea
          ...
          rows={2}
          className="w-full rounded-xl border border-[#e8dfd2] bg-white px-2 py-1.5 text-sm focus:outline-none focus:border-kraft focus:ring-1 focus:ring-kraft transition resize-none"
        />
      </div>
