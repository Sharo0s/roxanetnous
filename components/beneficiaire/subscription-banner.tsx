...
export function BeneficiaireSubscriptionBanner() {
  return (
    <div className="bg-white rounded-xl border-2 border-accent p-6">
      ...
      <p className="text-gray-600 mb-4">
        Souscrivez un abonnement pour acceder a la recherche d'auxiliaires et publier des annonces.
      </p>
      <Link
        href="/beneficiaire/abonnement"
