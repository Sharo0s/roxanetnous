...
import { updateUserInfo, updateAccompagneProfile } from '@/app/actions/profile'
...
export function AccompagneProfileForm({ userInfo, profile }: Props) {
  ...
  async function handleSave() {
    ...
    const profileResult = await updateAccompagneProfile({
      ville,
