...
const links: LinkDef[] = [
  { href: '/accompagne/dashboard', label: 'Accueil', key: 'dashboard' },
  { href: '/accompagne/annonces', label: 'Annonces', key: 'annonces' },
  { href: '/recherche', label: 'Recherche', key: 'recherche' },
  { href: '/messages', label: 'Messages', key: 'messages', badge: true },
  { href: '/favoris', label: 'Favoris', key: 'favoris' },
  { href: '/accompagne/profil', label: 'Profil', key: 'profil' },
]

export function AccompagneDashboardHeader({ firstName, lastName, unreadCount, currentPage = 'dashboard' }: Props) {
  const [menuOpen, setMenuOpen] = useState(false)

  return (
    <header className="bg-[#faf7f2] border-b border-[#e8dfd2] relative z-10">
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
        <Link href="/accompagne/dashboard" className="text-lg font-bold text-black">
          roxanetnous
        </Link>
