...
export const metadata = {
  title: 'roxanetnous - Landing V5 (Carte de France)',
  robots: 'noindex',
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      {launchOfferActive && (
        <div className="overflow-hidden bg-black">
          <div className="animate-marquee whitespace-nowrap py-3 text-base font-bold" style={{ color: '#FFB06E' }}>
      ...
      <main className="flex-1">
        {/* ===== HERO ===== */}
        <section className="px-4 py-16 md:py-24 kraft" style={{ backgroundColor: '#F5E1C8' }}>
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
              <div className="flex-1 text-center md:text-left space-y-5">
                ...
                <div className="flex gap-4 justify-center md:justify-start pt-4">
                  <Link
                    href="/login"
                    className="px-6 py-3 rounded-lg font-semibold text-sm text-black btn-hover"
        ...
        {/* ===== BANDE COMMUNAUTE ===== */}
        <section style={{ backgroundColor: '#FFB06E' }}>
          <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col items-center gap-4 text-center md:flex-row md:justify-between md:text-left">
            <p className="text-base font-medium text-black tracking-wide">
              Premiere communaute de mise en relation entre accompagnants et accompagné(e)s
            </p>
            <div className="flex flex-col md:flex-row gap-3 items-center text-sm shrink-0">
              ...
              <div className="flex gap-3 flex-wrap justify-center">
                {(auxiliairesCount || 0) > 0 && (
                  <span className="rounded-full px-4 py-1.5 font-medium text-black whitespace-nowrap overflow-hidden relative" style={{ backgroundColor: '#F5E1C8' }}>
                    ...
                    <span className="relative">Deja {auxiliairesCount} accompagnant(e){(auxiliairesCount || 0) > 1 ? 's' : ''} vérifié(e){(auxiliairesCount || 0) > 1 ? 's' : ''}</span>
                  </span>
                )}
        ...
        {/* ===== COMMENT CA MARCHE ===== */}
        <section className="px-4 py-16 kraft" style={{ backgroundColor: '#F5E1C8' }}>
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <div className="space-y-0">
              {[
                { step: '1', title: 'Inscription', desc: "Creez votre compte en tant qu'accompagnant(e) ou accompagné(e).." },
                { step: '2', title: 'Justificatifs', desc: "Accompagnant(e)s : deposez vos diplomes et piece d'identite. Accompagné(e)s : decrivez votre besoin." },
                ...
                <div key={item.step} className="flex gap-6 items-start">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 text-black" style={{ backgroundColor: '#FFB06E' }}>
                      {item.step}
                    </div>
                    {i < 3 && <div className="w-px h-16" style={{ backgroundColor: '#FFB06E', opacity: 0.4 }} />}
                  </div>
                  <div className="pb-10">
        ...
        <section className="px-4 py-16 bg-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border-2 rounded-xl p-8" style={{ borderColor: '#FFB06E' }}>
                <h3 className="font-bold text-xl text-black mb-6">Accompagnant(e)s</h3>
                <ul className="space-y-4 text-sm text-black">
                  {['Profil verifie qui inspire confiance', 'Visibilite directe aupres des accompagné(e)s', 'Profils recommandes selon vos competences', 'Pas de commission. Vous fixez vos conditions.'].map((text) => (
                    <li key={text} className="flex gap-3">
                      <span className="shrink-0 w-5 h-5 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FFB06E' }}>
                ...
                <Link
                  ...
                  className="block text-center mt-8 px-4 py-3 rounded-lg text-sm font-medium text-black btn-hover"
                  style={{ backgroundColor: '#FFB06E' }}
                >
        ...
        <section className="px-4 py-16 kraft" style={{ backgroundColor: '#F5E1C8' }}>
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <p className="text-center text-sm text-black mb-10">
              Meme prix pour les accompagnant(e)s et les accompagné(e)s.            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="border rounded-xl p-6 bg-white flex flex-col" style={{ borderColor: '#FFB06E' }}>
                <h3 className="font-bold text-lg text-black mb-1">Mensuel</h3>
                <p className="text-3xl font-bold mb-1">
                  <span style={{ color: '#FFB06E' }}>4,99 €</span><span className="text-sm font-normal text-black"> / mois</span>
                </p>
                <p className="text-sm text-black mb-4">Sans engagement, resiliable a tout moment.</p>
                <Link
                  href="/register"
                  className="block text-center px-4 py-2 rounded-lg text-sm font-medium text-black btn-hover mt-auto"
                  style={{ backgroundColor: '#FFB06E' }}
                >
                  Commencer
                </Link>
              </div>
              <div className="border-2 rounded-xl p-6 bg-white relative flex flex-col" style={{ borderColor: '#FFB06E' }}>
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-xs px-3 py-1 rounded-full font-medium text-black" style={{ backgroundColor: '#FFB06E' }}>
                  Recommande
                </div>
                <h3 className="font-bold text-lg text-black mb-1">Annuel</h3>
                <p className="text-3xl font-bold text-black mb-1 whitespace-nowrap">
                  <span className="text-xl font-normal text-black line-through mr-2">59,88 €</span>
                  <span style={{ color: '#FFB06E' }}>49,99 €</span><span className="text-sm font-normal text-black"> / an</span>
                </p>
                <p className="text-sm text-black mb-4">Soit 4,17 € / mois. Economisez 17%.</p>
                <Link
                  href="/register"
                  className="block text-center px-4 py-2 rounded-lg text-sm font-medium text-black btn-hover mt-auto"
                  style={{ backgroundColor: '#FFB06E' }}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
              {[
                ...
                { q: "Combien coute l'abonnement ?", a: "L'abonnement mensuel est a 4,99 €/mois sans engagement. L'abonnement annuel est a 49,99 €/an, soit une economie de 17%." },
                ...
                { q: 'Comment contacter un(e) accompagnant(e) ?', a: "Une fois inscrit en tant qu'accompagné(e), vous pouvez envoyer un message via la messagerie integree a partir de la fiche de l'accompagnant(e)." },
                ...
                <details key={i} className="group rounded-xl bg-white p-5" style={{ border: '1px solid #FFB06E' }}>
                  <summary className="cursor-pointer flex gap-4 items-start">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm shrink-0 text-black" style={{ backgroundColor: '#FFB06E' }}>
                      {i + 1}
                    </div>
