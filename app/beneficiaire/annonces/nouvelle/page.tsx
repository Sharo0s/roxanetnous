...
export default function NouvelleAnnonceBeneficiaire() {
  ...
  const [messageAuxiliaires, setMessageAuxiliaires] = useState('')
  ...
  async function handleSubmit() {
    ...
    setLoading(true)
    const result = await createAnnonceBeneficiaire({
      titre,
      description,
    ...
    <main className="min-h-screen bg-gray-50">
      <header className="bg-white border-b">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/beneficiaire/annonces" className="text-sm text-gray-500 hover:text-black">
            Retour aux annonces
          </Link>
        </div>
      </header>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ex: Recherche auxiliaire de vie pour personne agee"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Un mot personnel pour les auxiliaires qui verront votre annonce..."
                    rows={3}
                    className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-black resize-none"
                  />
                </div>
