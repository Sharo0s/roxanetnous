...
export default async function AbonnementBeneficiaireSuccessPage() {
      ...
      <div className="max-w-md mx-auto px-4 text-center">
        <div className="bg-white rounded-xl border p-8">
          ...
          <p className="text-gray-600 mb-6">
            Votre abonnement a ete active avec succes. Vous pouvez desormais rechercher des auxiliaires et publier des annonces.
          </p>
