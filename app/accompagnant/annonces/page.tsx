...
export default async function MesAnnoncesAccompagnante() {
  ...
  if (!profile || profile.validation_status !== 'valide') redirect('/accompagnant/dashboard')
    ...
    <main id="main-content" tabIndex={-1} className="min-h-screen bg-[#fefaf8] focus:outline-none">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 md:py-14 relative z-10">
        ...
        <header className="mb-10 flex items-end justify-between gap-4 flex-wrap">
          ...
          {subscribed && (
            <Link
              href="/accompagnant/annonces/nouvelle"
                ...
                >
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
                      <Link
                        href={`/accompagnant/annonces/${annonce.id}/modifier`}
